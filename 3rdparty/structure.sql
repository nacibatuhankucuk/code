...
--
-- Anamakine: localhost
-- Üretim Zamanı: 17 Aralık 2012 saat 20:05:53
-- Sunucu sürümü: 5.5.8
-- PHP Sürümü: 5.3.5
...
-- Veritabanı: `beta`
--
CREATE DATABASE `beta` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `beta`;
--
-- Veritabanı: `cdcol`
--
...
--
-- Tablo için tablo yapısı `CHARACTER_SETS`
--
...
--
-- Tablo için tablo yapısı `COLLATIONS`
--
...
--
-- Tablo için tablo yapısı `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- Tablo için tablo yapısı `COLUMN_PRIVILEGES`
--
...
--
-- Tablo için tablo yapısı `ENGINES`
--
...
--
-- Tablo için tablo yapısı `GLOBAL_STATUS`
--
...
--
-- Tablo için tablo yapısı `GLOBAL_VARIABLES`
--
...
--
-- Tablo için tablo yapısı `KEY_COLUMN_USAGE`
--
...
--
-- Tablo için tablo yapısı `PARTITIONS`
--
...
--
-- Tablo için tablo yapısı `PROCESSLIST`
--
...
--
-- Tablo için tablo yapısı `PROFILING`
--
...
--
-- Tablo için tablo yapısı `REFERENTIAL_CONSTRAINTS`
--
...
--
-- Tablo için tablo yapısı `ROUTINES`
--
...
--
-- Tablo için tablo yapısı `SCHEMATA`
--
...
--
-- Tablo için tablo yapısı `SCHEMA_PRIVILEGES`
--
...
--
-- Tablo için tablo yapısı `SESSION_STATUS`
--
...
--
-- Tablo için tablo yapısı `SESSION_VARIABLES`
--
...
--
-- Tablo için tablo yapısı `TABLESPACES`
--
...
--
-- Tablo için tablo yapısı `TABLE_CONSTRAINTS`
--
...
--
-- Tablo için tablo yapısı `TABLE_PRIVILEGES`
--
...
--
-- Tablo için tablo yapısı `TRIGGERS`
--
...
--
-- Tablo için tablo yapısı `USER_PRIVILEGES`
--
...
--
-- Tablo için tablo yapısı `INNODB_CMP_RESET`
--
...
--
-- Tablo için tablo yapısı `INNODB_TRX`
--
...
--
-- Tablo için tablo yapısı `INNODB_CMPMEM_RESET`
--
...
--
-- Tablo için tablo yapısı `INNODB_LOCK_WAITS`
--
...
--
-- Tablo için tablo yapısı `INNODB_CMPMEM`
--
...
--
-- Tablo için tablo yapısı `INNODB_CMP`
--
...
--
-- Tablo için tablo yapısı `INNODB_LOCKS`
--
...
--
-- Tablo için tablo yapısı `columns_priv`
--
...
--
-- Tablo için tablo yapısı `general_log`
--
...
--
-- Tablo için tablo yapısı `help_category`
--
...
--
-- Tablo için tablo yapısı `help_keyword`
--
...
--
-- Tablo için tablo yapısı `help_relation`
--
...
--
-- Tablo için tablo yapısı `help_topic`
--
...
--
-- Tablo için tablo yapısı `ndb_binlog_index`
--
...
--
-- Tablo için tablo yapısı `plugin`
--
...
--
-- Tablo için tablo yapısı `procs_priv`
--
...
--
-- Tablo için tablo yapısı `proxies_priv`
--
...
--
-- Tablo için tablo yapısı `slow_log`
--
...
--
-- Tablo için tablo yapısı `tables_priv`
--
...
--
-- Tablo için tablo yapısı `time_zone`
--
...
--
-- Tablo için tablo yapısı `time_zone_leap_second`
--
...
--
-- Tablo için tablo yapısı `time_zone_name`
--
...
--
-- Tablo için tablo yapısı `time_zone_transition`
--
...
--
-- Tablo için tablo yapısı `time_zone_transition_type`
--
...
--
-- Tablo için tablo yapısı `cond_instances`
--
...
--
-- Tablo için tablo yapısı `events_waits_current`
--
...
--
-- Tablo için tablo yapısı `events_waits_history`
--
...
--
-- Tablo için tablo yapısı `events_waits_history_long`
--
...
--
-- Tablo için tablo yapısı `events_waits_summary_by_instance`
--
...
--
-- Tablo için tablo yapısı `events_waits_summary_by_thread_by_event_name`
--
...
--
-- Tablo için tablo yapısı `events_waits_summary_global_by_event_name`
--
...
--
-- Tablo için tablo yapısı `file_instances`
--
...
--
-- Tablo için tablo yapısı `file_summary_by_event_name`
--
...
--
-- Tablo için tablo yapısı `file_summary_by_instance`
--
...
--
-- Tablo için tablo yapısı `mutex_instances`
--
...
--
-- Tablo için tablo yapısı `performance_timers`
--
...
--
-- Tablo için tablo yapısı `rwlock_instances`
--
...
--
-- Tablo için tablo yapısı `setup_consumers`
--
...
--
-- Tablo için tablo yapısı `setup_instruments`
--
...
--
-- Tablo için tablo yapısı `setup_timers`
--
...
-- Veritabanı: `timeout`
--
CREATE DATABASE `timeout` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `timeout`;

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `ab_xr_sessions`
--

CREATE TABLE IF NOT EXISTS `ab_xr_sessions` (
...
--
-- Tablo için tablo yapısı `xr_banlist`
--

CREATE TABLE IF NOT EXISTS `xr_banlist` (
  `id` int(10) NOT NULL DEFAULT '0',
  `username` varchar(100) DEFAULT NULL,
  `ban_starttime` date DEFAULT NULL,
  `ban_endtime` date DEFAULT NULL,
  `ban_reason` varchar(255) DEFAULT NULL,
  `ban_type` tinyint(5) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Tablo için tablo yapısı `xr_bots`
--

CREATE TABLE IF NOT EXISTS `xr_bots` (
...
--
-- Tablo için tablo yapısı `xr_config`
--
...
--
-- Tablo için tablo yapısı `xr_confirm`
--

CREATE TABLE IF NOT EXISTS `xr_confirm` (
...
--
-- Tablo için tablo yapısı `xr_lang`
--

CREATE TABLE IF NOT EXISTS `xr_lang` (
...
--
-- Tablo için tablo yapısı `xr_login_attempts`
--

CREATE TABLE IF NOT EXISTS `xr_login_attempts` (
...
--
-- Tablo için tablo yapısı `xr_posts`
--

CREATE TABLE IF NOT EXISTS `xr_posts` (
  `post_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `thread_id` int(10) DEFAULT NULL,
  `post_username` varchar(100) DEFAULT NULL,
  `post_userid` int(10) DEFAULT NULL,
  `post_entry` longtext,
  `post_userip` char(15) DEFAULT NULL,
  `post_type` smallint(6) DEFAULT NULL,
  `post_datetime` datetime DEFAULT NULL,
  `post_reputation` int(10) DEFAULT NULL,
  `post_typereason` longtext,
  PRIMARY KEY (`post_id`),
  KEY `userid` (`post_userid`) USING BTREE,
  KEY `threadid` (`thread_id`,`post_userid`) USING BTREE,
  KEY `dateline` (`post_datetime`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=305 ;

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `xr_reputation`
--

CREATE TABLE IF NOT EXISTS `xr_reputation` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `post_id` int(5) NOT NULL,
  `user_id` int(5) DEFAULT NULL,
  `type` tinyint(5) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `postid` (`post_id`) USING BTREE,
  KEY `type` (`type`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=938301 ;

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `xr_sessions_keys`
--

CREATE TABLE IF NOT EXISTS `xr_sessions_keys` (
...
--
-- Tablo için tablo yapısı `xr_styles`
--

CREATE TABLE IF NOT EXISTS `xr_styles` (
...
--
-- Tablo için tablo yapısı `xr_users`
--

CREATE TABLE IF NOT EXISTS `xr_users` (
  ...
  `user_statusinfo` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `user_city` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `user_gender` varchar(10) CHARACTER SET utf8 DEFAULT NULL,
  `user_profileview` int(10) DEFAULT NULL,
  `user_joindate` datetime DEFAULT NULL,
  `user_posts` int(10) DEFAULT NULL,
  `user_login_attempts` tinyint(4) DEFAULT '0',
  `user_ipaddress` varchar(15) CHARACTER SET utf8 DEFAULT NULL,
  `user_new_privmsg` int(4) DEFAULT NULL,
  `user_unread_privmsg` int(4) DEFAULT NULL,
  `user_lastvisit` int(11) DEFAULT NULL,
  `user_lastpost` int(11) DEFAULT NULL,
  `user_avatar` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `user_reputation` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `user_lang` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `user_timezone` decimal(5,2) DEFAULT NULL,
  `user_dst` tinyint(1) DEFAULT NULL,
  `user_dateformat` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `user_style` mediumint(8) DEFAULT NULL,
  PRIMARY KEY (`user_id`),
  KEY `username` (`username`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=10950 ;
--
-- Veritabanı: `webauth`
--
